            ...
            for column in range(column_size):
                ...
                # Top row without diagonals
                    ...
                    if grid[row][column] == 1:
                        ...
                        color = RED
                    elif bottom_right or bottom_left:
                        color = YELLOW
                ...
                # Top right diagonals
                    ...
                    if grid[row][column] == 1:
                        color = GREEN
                    elif left or top or right or bottom:
                        color = RED
                    elif top_left or top_right or bottom_right or bottom_left:
                        color = YELLOW
